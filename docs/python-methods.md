[Here is the gitHub repository for saucpy](https://github.com/sbohora/saucpy)

Below is a class called **sAUC** which contains several methods to perform Semi-parametric Area Under the Curve (sAUC) Regression
